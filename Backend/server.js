...
app.use(cors({
  origin: [
    ...
    "http://43.205.235.218:3083",
    "http://127.0.0.1:5500",
    "http://43.205.235.218:5500",
    "http://127.0.0.1:5501",
    "http://127.0.0.1:5503",
    "http://43.205.235.218:9035",
    "http://43.205.235.218:9036",
  ],
...
// Start server
app.listen(port, () => {
  console.log(`Server running on http://43.205.235.218:${port}`);
});
