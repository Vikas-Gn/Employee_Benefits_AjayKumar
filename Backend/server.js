...
app.use(cors({
  origin: [
    ...
    "http://13.235.128.250:3083",
    "http://127.0.0.1:5500",
    "http://localhost:5500",
    "http://127.0.0.1:5501", // Added to fix CORS error
    "http://13.235.128.250:9035", // Added for future port flexibility
    "http://13.235.128.250:9036"  // Added for future port flexibility
  ],
...
// Start server
app.listen(port, () => {
  console.log(`Server running on http://13.235.128.250:${port}`);
});